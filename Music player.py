...
def play_next():   
    ...
    next_song_name = listbox.get(next_song_name)
...
listbox = tk.Listbox(canvas,fig = "cyan" , bg ="black",width=100, font=('poppins',15))
...
stopButton = tk.Button(canvas , text = "Stop",image= prev_img,bg='black',borderwidth=0, command=stop)
